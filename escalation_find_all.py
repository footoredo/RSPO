...
def main():
    ...
    max_steps = initial_config["episode_steps"]
    ...
    while True:
        ...
        for folder in os.listdir(save_dir):
            ...
            try:
                ...
                cnt_after_meeting = play_statistics["cnt_after_meeting"]

                max_coop = 0
                for j in reversed(range(max_steps)):
                    if cnt_after_meeting[j] > 80:
                        max_coop = j + 1
                        break
                total[max_coop] += 1
                _findings.append((_save_dir, max_coop))
            except NotADirectoryError:
                pass

        for save_dir, _ in _findings:
        ...
        joblib.dump((findings, total), findings_file)
